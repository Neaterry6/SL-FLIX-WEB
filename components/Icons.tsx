...
export const PiPIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <rect x="11" y="7" width="9" height="7" rx="1" />
  </svg>
);
...
export const DownloadProgressIcon: React.FC<{ className?: string; progress?: number }> = ({ className = "w-6 h-6", progress = 0 }) => {
  ...
  return (
    <svg className={className} viewBox="0 0 24 24">
      ...
      <circle cx="12" cy="12" r="8" fill="none" stroke="currentColor" strokeWidth="2" strokeDasharray={circumference} strokeDashoffset={strokeDashoffset} strokeLinecap="round" transform="rotate(-90 12 12)" />
    </svg>
  );
};
